...
import com.github.yuxiaobin.mybatis.gm.utils.ReflectionUtil;
 ...
 * <BR>
 * <BR>
 * Current only Support updateById(), updateSeletiveById()
 * <BR>
 * Version Type Support(by default): int/Integer, long/Long, java.util.Date, java.sql.Timestamp<BR>
 *
...
public class OptimisticLockerInterceptor implements Interceptor {
    ...
    private static final String UPDATE_BY_ID_PREFIX = "update";
    private static final String UPDATE_BY_ID_SUFFIX = "ById";
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        //Only support updateById, updateSeletiveById
        if(updateMethodName.startsWith(UPDATE_BY_ID_PREFIX) && updateMethodName.endsWith(UPDATE_BY_ID_SUFFIX)){
            Object param = args[1];
            if (param instanceof Map) {
                ...
                if (versionField != null && (originalVersionVal = versionField.get(et)) != null) {
                    ...
                    if (versionColumnName != null) {
                        ...
                        map.put(MP_OPTLOCK_VERSION_COLUMN, versionColumnName);
                    }
                }
            }
        }
    ...
    private List<EntityField> getFieldsFromClazz(Class<?> parameterClass, List<EntityField> fieldList) {
        ...
        List<Field> fields = ReflectionUtil.getFieldList(parameterClass);
