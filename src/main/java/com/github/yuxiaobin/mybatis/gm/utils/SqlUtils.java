...
import com.github.yuxiaobin.mybatis.gm.plus.JsqlParserCountOptimize;
...
public class SqlUtils {
    ...
    private static ISqlParser DEFAULT_PARSER = new JsqlParserCountOptimize();
    ...
    public static SqlInfo getOptimizeCountSql(boolean optimizeCountSql, ISqlParser sqlParser, String originalSql) {
        ...
        if (null == COUNT_SQL_PARSER) {
            if (null != sqlParser) {
                ...
                try {
                    COUNT_SQL_PARSER = DEFAULT_PARSER;
                } catch (Exception e) {
